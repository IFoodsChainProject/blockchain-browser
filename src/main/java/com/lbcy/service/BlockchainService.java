...
public class BlockchainService
{
    ...
    public Block getBlockFromBlockchain(Long blockId) throws JsonProcessingException
    {
        ...
        if(blockId == 1 || blockId == 1775L || blockId == 53|| blockId == 118L|| blockId == 1711|| blockId == 99376|| blockId == 99655 || blockId == 1000052L) {
            logger.info(""+blockId);
        }
    ...
    public boolean findAndSave(long blockId) throws JsonProcessingException
    {
        ...
        for (Transaction transaction : transactions)
        {
            ...
            logger.info("transactionService deal start block is {}, TxType is {} ", blockId, transaction.getTxType());
            transactionService.deal(transaction);
            logger.info("transactionService deal end block is {}, TxType is {} ", blockId, transaction.getTxType());
        }
